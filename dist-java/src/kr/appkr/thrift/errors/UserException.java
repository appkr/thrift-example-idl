...
public class UserException extends org.apache.thrift.TException implements org.apache.thrift.TBase<UserException, UserException._Fields>, java.io.Serializable, Cloneable, Comparable<UserException> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new UserExceptionStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new UserExceptionTupleSchemeFactory();
   ...
   * @see ErrorCode
   */
  public UserException setCode(ErrorCode code) {
    this.code = code;
    return this;
  }
  ...
  public UserException setMessage(String message) {
        ...
        switch (schemeField.id) {
          case 1: // CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.code = kr.appkr.thrift.errors.ErrorCode.findByValue(iprot.readI32());
