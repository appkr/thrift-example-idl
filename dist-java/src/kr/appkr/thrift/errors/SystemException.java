...
public class SystemException extends org.apache.thrift.TException implements org.apache.thrift.TBase<SystemException, SystemException._Fields>, java.io.Serializable, Cloneable, Comparable<SystemException> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new SystemExceptionStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new SystemExceptionTupleSchemeFactory();
