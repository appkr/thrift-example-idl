...
public class Post implements org.apache.thrift.TBase<Post, Post._Fields>, java.io.Serializable, Cloneable, Comparable<Post> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new PostStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new PostTupleSchemeFactory();
   ...
   * 포스트 최종 수정 시각
   */
  public String updated_at; // optional
   ...
   * 포스트 최종 수정 시각
   */
  public Post setUpdated_at(String updated_at) {
